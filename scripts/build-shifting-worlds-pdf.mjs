...
const pdfPath = resolve(root, "public", "downloads", "shifting-worlds-kevin-l-michel.pdf");
const printInput = resolve(root, "dist", "books", "shifting-worlds", "print", "index.html");
const printStylesheet = resolve(root, "public", "shifting-worlds-book-print.css");
...
console.log("Building Astro print route for Shifting Worlds...");
await run(nodeCommand, [astroCommand, "build"]);

console.log("Generating Shifting Worlds trade-book PDF...");
