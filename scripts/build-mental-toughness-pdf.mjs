...
const pdfPath = resolve(root, "public", "downloads", "mental-toughness-kevin-l-michel.pdf");
const printInput = resolve(root, "dist", "books", "mental-toughness-dreams", "print", "index.html");
const printStylesheet = resolve(root, "public", "mental-toughness-book-print.css");
...
console.log("Building Astro print route for Mental Toughness...");
await run(nodeCommand, [astroCommand, "build"]);

console.log("Generating Mental Toughness trade-book PDF...");
