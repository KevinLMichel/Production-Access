...
const coverPath = resolve(root, "production", "covers", "output", "shifting-worlds-cover-wrap.pdf");
const coverInput = resolve(root, "dist", "books", "shifting-worlds", "cover-print", "index.html");
const coverStylesheet = resolve(root, "public", "shifting-worlds-cover.css");
...
async function writeCoverPdf(pngBuffer) {
  ...
  pdf.setTitle("Shifting Worlds - Paperback Cover");
...
console.log("Building Astro cover route for Shifting Worlds...");
