...
const coverPath = resolve(root, "production", "covers", "output", "the-kindness-algorithm-cover-wrap.pdf");
const coverInput = resolve(root, "dist", "books", "kindness-algorithm", "cover-print", "index.html");
const coverStylesheet = resolve(root, "public", "kindness-cover.css");

const sheetWidthIn = 11.722222;
...
async function writeCoverPdf(pngBuffer) {
  ...
  pdf.setTitle("The Kindness Algorithm - Paperback Cover");
...
console.log("Building Astro cover route for The Kindness Algorithm...");
