...
const pdfPath = resolve(root, "public", "downloads", "the-subconscious-advantage-kevin-l-michel.pdf");
const printInput = resolve(root, "dist", "books", "subconscious-advantage", "print", "index.html");
const printStylesheet = resolve(root, "public", "subconscious-book-print.css");
...
console.log("Building Astro print route for The Subconscious Advantage...");
await run(nodeCommand, [astroCommand, "build"]);

console.log("Generating The Subconscious Advantage trade-book PDF...");
