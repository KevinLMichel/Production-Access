...
const pdfPath = resolve(root, "public", "downloads", "the-clock-with-no-hands-kevin-l-michel.pdf");
const printInput = resolve(root, "dist", "books", "clock-with-no-hands", "print", "index.html");
const printStylesheet = resolve(root, "public", "clock-with-no-hands-book-print.css");
...
console.log("Building Astro print route for The Clock with No Hands...");
await run(nodeCommand, [astroCommand, "build"]);

console.log("Generating The Clock with No Hands trade-book PDF...");
