...
const pdfPath = resolve(root, "public", "downloads", "the-kindness-algorithm-kevin-l-michel.pdf");
const printInput = resolve(root, "dist", "books", "kindness-algorithm", "print", "index.html");
const printStylesheet = resolve(root, "public", "kindness-book-print.css");
...
console.log("Building Astro print route for The Kindness Algorithm...");
await run(nodeCommand, [astroCommand, "build"]);

console.log("Generating The Kindness Algorithm trade-book PDF...");
