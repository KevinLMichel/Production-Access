...
const pdfPath = resolve(root, "public", "downloads", "i-am-what-happens-kevin-l-michel.pdf");
const printInput = resolve(root, "dist", "books", "i-am-what-happens", "print", "index.html");
const printStylesheet = resolve(root, "public", "i-am-what-happens-book-print.css");
...
console.log("Building Astro print route for I Am What Happens...");
await run(nodeCommand, [astroCommand, "build"]);

console.log("Generating I Am What Happens poetic trade-book PDF...");
