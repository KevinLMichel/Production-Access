...
const pdfPath = resolve(root, "public", "downloads", "steam-over-cold-steel-kevin-l-michel.pdf");
const printInput = resolve(root, "dist", "books", "steam-over-cold-steel", "print", "index.html");
const printStylesheet = resolve(root, "public", "steam-book-print.css");
...
console.log("Building Astro print route for Steam Over Cold Steel...");
await run(nodeCommand, [astroCommand, "build"]);

console.log("Generating Steam Over Cold Steel trade-book PDF...");
